...
const STEP_LABELS = ["หัวหน้าสาขา", "สารบรรณคณะ", "หัวหน้าสำนักงานคณบดี", "รองคณบดีฝ่ายบริหาร", "คณบดี"];
...
const TEMPLATES = {
  ...
  APPROVER1_APPROVED: (d) => ({
    ...
    lines: [
      "เรียน สารบรรณคณะ,",
      `คำขอลาจาก <b>${d.userName}</b> ได้รับการอนุมัติจากหัวหน้าสาขาแล้ว ${proxyLine(d)} กรุณาตรวจสอบและออกเลขที่ใบลา`,
    ],
    details: leaveDetails(d),
    progress: { current: 2 },
  }),
  VERIFIER_APPROVED: (d) => ({
    subject: "คำขอลาได้รับการอนุมัติจากสารบรรณคณะ",
    heading: "มีคำขอลารอการอนุมัติ",
    tone: "info",
    badge: "รอการอนุมัติ",
    lines: [
      "เรียน หัวหน้าสำนักงานคณบดี,",
      `คำขอลาจาก <b>${d.userName}</b> ได้รับการอนุมัติจากสารบรรณคณะแล้ว ${proxyLine(d)} กรุณาพิจารณาอนุมัติขั้นต่อไป`,
    ],
    details: leaveDetails(d),
    progress: { current: 3 },
  }),
  APPROVER2_APPROVED: (d) => ({
    subject: "คำขอลาได้รับการอนุมัติจากหัวหน้าสำนักงานคณบดี",
    heading: "มีคำขอลารอการอนุมัติ",
    tone: "info",
    badge: "รอการอนุมัติ",
    lines: [
      "เรียน รองคณบดีฝ่ายบริหาร,",
      `คำขอลาจาก <b>${d.userName}</b> ได้รับการอนุมัติจากหัวหน้าสำนักงานคณบดีแล้ว ${proxyLine(d)} กรุณาพิจารณาอนุมัติขั้นต่อไป`,
    ],
    details: leaveDetails(d),
    progress: { current: 4 },
  }),
  APPROVER3_APPROVED: (d) => ({
    subject: "คำขอลาได้รับการอนุมัติจากรองคณบดีฝ่ายบริหาร",
    heading: "มีคำขอลารอการอนุมัติขั้นสุดท้าย",
    tone: "info",
    badge: "รออนุมัติขั้นสุดท้าย",
    lines: [
      "เรียน คณบดี,",
      `คำขอลาจาก <b>${d.userName}</b> ได้รับการอนุมัติจากรองคณบดีฝ่ายบริหารแล้ว ${proxyLine(d)} กรุณาพิจารณาอนุมัติขั้นสุดท้าย`,
    ],
    details: leaveDetails(d),
    progress: { current: 5 },
  }),
  ...
  STEP_APPROVED_2: (d) => ({
    subject: "คำขอลาของคุณได้รับการอนุมัติจากสารบรรณคณะ",
    heading: "คำขอลาผ่านขั้นที่ 2",
    tone: "success",
    badge: "ผ่านขั้นที่ 2",
    lines: [
      `เรียน ${d.userName},`,
      "คำขอลาของคุณได้รับการอนุมัติเรียบร้อยแล้วจากสารบรรณคณะ กรุณาตรวจสอบสถานะในระบบ",
    ],
    details: leaveDetails(d),
    progress: { current: 3 },
  }),
  STEP_APPROVED_3: (d) => ({
    subject: "คำขอลาของคุณได้รับการอนุมัติจากหัวหน้าสำนักงานคณบดี",
    heading: "คำขอลาผ่านขั้นที่ 3",
    tone: "success",
    badge: "ผ่านขั้นที่ 3",
    lines: [
      `เรียน ${d.userName},`,
      "คำขอลาของคุณได้รับการอนุมัติเรียบร้อยแล้วจากหัวหน้าสำนักงานคณบดี กรุณาตรวจสอบสถานะในระบบ",
    ],
    details: leaveDetails(d),
    progress: { current: 4 },
  }),
  STEP_APPROVED_4: (d) => ({
    subject: "คำขอลาของคุณได้รับการอนุมัติจากรองคณบดีฝ่ายบริหาร",
    heading: "คำขอลาผ่านขั้นที่ 4",
    tone: "success",
    badge: "ผ่านขั้นที่ 4",
    lines: [
      `เรียน ${d.userName},`,
      "คำขอลาของคุณได้รับการอนุมัติเรียบร้อยแล้วจากรองคณบดีฝ่ายบริหาร กรุณาตรวจสอบสถานะในระบบ",
    ],
    details: leaveDetails(d),
    progress: { current: 5 },
  }),
