...
router.post("/", leaveRequestLimiter, authenticate, leaveRequestController.createLeaveRequest);
router.patch("/:id", authenticate, leaveRequestController.updateLeaveRequest);
// update status unified
router.patch("/:id/status", authenticate, leaveRequestController.updateLeaveStatus);
